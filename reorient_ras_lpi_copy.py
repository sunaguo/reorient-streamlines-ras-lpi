...
n_points = 100
reference_anat_path = "./sub-100206/dwi/dwi.nii.gz"
classification_path = "./sub-100206/wmc_cleaned-SD3/classification.mat"
streamlines_path = "./sub-100206/track-tck_lmax-8/track.tck"
